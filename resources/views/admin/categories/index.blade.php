...
<div class="flex justify-between items-center mb-8">
    <div>
        ...
        <p class="text-gray-600 mt-2">Organize your posts with categories</p>
    </div>
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex items-center space-x-2">
                            ...
                            @else
                                <span class="p-2 text-gray-400 cursor-not-allowed" title="Cannot delete category with posts">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                    </svg>
                                </span>
...
<div class="text-center py-12 bg-white rounded-xl shadow-sm">
    ...
    <h3 class="mt-4 text-xl font-medium text-gray-900">No categories yet</h3>
    <p class="mt-2 text-gray-500">Create categories to organize your blog posts.</p>
    <div class="mt-6">
        <a href="{{ route('admin.categories.create') }}" 
