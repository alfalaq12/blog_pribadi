            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           id="title" 
                           value="{{ old('title') }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:# Admin Views - Dashboard yang Cantik dan Fungsional

## Step 1: Admin Dashboard (`resources/views/admin/dashboard.blade.php`)
```php
@extends('layouts.admin')
